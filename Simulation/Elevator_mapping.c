...
static int isActive_SSM_TR_SM2_RUNNING_elevator_state_SSM_TR_init_ELEVATOR_CLIMB_1_init_SM2_RUNNING_elevator_state(void* pHandle) { return *(SSM_TR_SM2_RUNNING_elevator_state*)pHandle == SSM_TR_init_ELEVATOR_CLIMB_1_init_SM2_RUNNING_elevator_state; }
...
const MappingEntry scope_14_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_7_entries[6], isActive_SSM_TR_SM2_RUNNING_elevator_state_SSM_TR_ELEVATOR_CLIMB_init_1_ELEVATOR_CLIMB_SM2_RUNNING_elevator_state, NULL, 1, 0 }
};
...
const MappingEntry scope_13_entries[4] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_7_entries[6], isActive_SSM_TR_SM2_RUNNING_elevator_state_SSM_TR_ELEVATOR_CLIMB_init_1_ELEVATOR_CLIMB_SM2_RUNNING_elevator_state, &scope_14, 1, 0 },
...
const MappingEntry scope_12_entries[1] = {
    /* 0 */ { MAP_LOCAL, "_L1", NULL, sizeof(tMotorCommand), (size_t)&outputs_ctx._L1_then_MotorControl_init_SM2_RUNNING_elevator_state, &_Type_tMotorCommand_Utils, &scope_10_entries[0], isActive_kcg_bool_kcg_true, NULL, 1, 0 }
};
...
const MappingEntry scope_11_entries[1] = {
    /* 0 */ { MAP_LOCAL, "_L1", NULL, sizeof(tMotorCommand), (size_t)&outputs_ctx._L1_else_MotorControl_init_SM2_RUNNING_elevator_state, &_Type_tMotorCommand_Utils, &scope_10_entries[0], isActive_kcg_bool_kcg_false, NULL, 1, 0 }
};
...
const MappingEntry scope_10_entries[3] = {
    /* 0 */ { MAP_LOCAL, "@condition", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx.MotorControl_clock_init_SM2_RUNNING_elevator_state, &_Type_kcg_bool_Utils, &scope_1_entries[7], isActive_SSM_ST_SM2_RUNNING_elevator_state_SSM_st_init_SM2_RUNNING_elevator_state, NULL, 0, 0 },
...
const MappingEntry scope_9_entries[1] = {
    /* 0 */ { MAP_WEAK_TRANSITION, ">:", NULL, 0, 0, NULL, &scope_7_entries[6], isActive_SSM_TR_SM2_RUNNING_elevator_state_SSM_TR_init_ELEVATOR_CLIMB_1_init_SM2_RUNNING_elevator_state, NULL, 1, 0 }
};
...
const MappingEntry scope_8_entries[4] = {
    /* 0 */ { MAP_FORK, "<1", NULL, 0, 0, NULL, &scope_7_entries[6], isActive_SSM_TR_SM2_RUNNING_elevator_state_SSM_TR_init_ELEVATOR_CLIMB_1_init_SM2_RUNNING_elevator_state, &scope_9, 1, 0 },
    /* 1 */ { MAP_LOCAL, "_L1", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L1_init_SM2_RUNNING_elevator_state, &_Type_kcg_bool_Utils, &scope_1_entries[7], isActive_SSM_ST_SM2_RUNNING_elevator_state_SSM_st_init_SM2_RUNNING_elevator_state, NULL, 1, 1 },
    /* 2 */ { MAP_LOCAL, "_L2", NULL, sizeof(kcg_bool), (size_t)&outputs_ctx._L2_init_SM2_RUNNING_elevator_state, &_Type_kcg_bool_Utils, &scope_1_entries[7], isActive_SSM_ST_SM2_RUNNING_elevator_state_SSM_st_init_SM2_RUNNING_elevator_state, NULL, 1, 2 },
    /* 3 */ { MAP_IF, "MotorControl:", NULL, 0, 0, NULL, NULL, NULL, &scope_10, 1, 3 }
};
...
const MappingEntry scope_7_entries[9] = {
    ...
    /* 7 */ { MAP_STATE, "init:", NULL, 0, 0, NULL, &scope_7_entries[0], isActive_SSM_ST_SM2_RUNNING_elevator_state_SSM_st_init_SM2_RUNNING_elevator_state, &scope_8, 1, 7 },
    /* 8 */ { MAP_STATE, "ELEVATOR_CLIMB:", NULL, 0, 0, NULL, &scope_7_entries[0], isActive_SSM_ST_SM2_RUNNING_elevator_state_SSM_st_ELEVATOR_CLIMB_SM2_RUNNING_elevator_state, &scope_13, 1, 8 }
};
...
const MappingEntry scope_1_entries[9] = {
    ...
    /* 7 */ { MAP_LOCAL, "@kcg1", NULL, sizeof(SSM_ST_SM2_RUNNING_elevator_state), (size_t)&outputs_ctx.SM2_clock_RUNNING_elevator_state, &_Type_SSM_ST_SM2_RUNNING_elevator_state_Utils, &scope_1_entries[8], isActive_SSM_ST_elevator_state_SSM_st_RUNNING_elevator_state, NULL, 0, 7 },
