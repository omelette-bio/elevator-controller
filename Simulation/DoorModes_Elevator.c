...
void DoorModes_init_Elevator(outC_DoorModes_Elevator *outC)
{
...
void DoorModes_reset_Elevator(outC_DoorModes_Elevator *outC)
{
  outC->init1 = kcg_true;
  outC->init = kcg_true;
  outC->SM1_reset_nxt = kcg_false;
