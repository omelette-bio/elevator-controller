...
static SimEnumValUtils SSM_ST_SM2_RUNNING_elevator_state_values[] = {
    { "init", SSM_st_init_SM2_RUNNING_elevator_state},
    { "init", SSM_st_init_SM2_RUNNING_elevator_state},
...
const int SSM_ST_SM2_RUNNING_elevator_state_nb_values = 6;
...
{
    *(SSM_ST_SM2_RUNNING_elevator_state*)pValue = SSM_st_init_SM2_RUNNING_elevator_state;
    return 1;
}
...
static SimEnumValUtils SSM_TR_SM2_RUNNING_elevator_state_values[] = {
    ...
    { "SSM_TR_no_trans_SM2_RUNNING_elevator_state", SSM_TR_no_trans_SM2_RUNNING_elevator_state},
    { "SSM_TR_init_ELEVATOR_DOWN_1_init_SM2_RUNNING_elevator_state", SSM_TR_init_ELEVATOR_DOWN_1_init_SM2_RUNNING_elevator_state},
    { "SSM_TR_init_ELEVATOR_DOWN_1_init_SM2_RUNNING_elevator_state", SSM_TR_init_ELEVATOR_DOWN_1_init_SM2_RUNNING_elevator_state},
    { "SSM_TR_init_ELEVATOR_CLIMB_2_init_SM2_RUNNING_elevator_state", SSM_TR_init_ELEVATOR_CLIMB_2_init_SM2_RUNNING_elevator_state},
    { "SSM_TR_init_ELEVATOR_CLIMB_2_init_SM2_RUNNING_elevator_state", SSM_TR_init_ELEVATOR_CLIMB_2_init_SM2_RUNNING_elevator_state},
    { "SSM_TR_ELEVATOR_CLIMB_init_1_ELEVATOR_CLIMB_SM2_RUNNING_elevator_state", SSM_TR_ELEVATOR_CLIMB_init_1_ELEVATOR_CLIMB_SM2_RUNNING_elevator_state},
    { "SSM_TR_ELEVATOR_CLIMB_init_1_ELEVATOR_CLIMB_SM2_RUNNING_elevator_state", SSM_TR_ELEVATOR_CLIMB_init_1_ELEVATOR_CLIMB_SM2_RUNNING_elevator_state},
    { "SSM_TR_ELEVATOR_DOWN_init_1_ELEVATOR_DOWN_SM2_RUNNING_elevator_state", SSM_TR_ELEVATOR_DOWN_init_1_ELEVATOR_DOWN_SM2_RUNNING_elevator_state},
    { "SSM_TR_ELEVATOR_DOWN_init_1_ELEVATOR_DOWN_SM2_RUNNING_elevator_state", SSM_TR_ELEVATOR_DOWN_init_1_ELEVATOR_DOWN_SM2_RUNNING_elevator_state},
};
const int SSM_TR_SM2_RUNNING_elevator_state_nb_values = 10;
