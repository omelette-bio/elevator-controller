...
const int SSM_ST_SM2_RUNNING_elevator_state_nb_values = 4;
...
static SimEnumValUtils SSM_TR_SM2_RUNNING_elevator_state_values[] = {
    ...
    { "SSM_TR_no_trans_SM2_RUNNING_elevator_state", SSM_TR_no_trans_SM2_RUNNING_elevator_state},
    { "SSM_TR_init_ELEVATOR_CLIMB_1_init_SM2_RUNNING_elevator_state", SSM_TR_init_ELEVATOR_CLIMB_1_init_SM2_RUNNING_elevator_state},
    { "SSM_TR_init_ELEVATOR_CLIMB_1_init_SM2_RUNNING_elevator_state", SSM_TR_init_ELEVATOR_CLIMB_1_init_SM2_RUNNING_elevator_state},
...
const int SSM_TR_SM2_RUNNING_elevator_state_nb_values = 6;
