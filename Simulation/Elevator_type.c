...
static kcg_int32 const TU_cFLOOR_TRAVEL_TIME = cFLOOR_TRAVEL_TIME;
static kcg_int32 const TU_cDOOR_MOVE_TIME = cDOOR_MOVE_TIME;
...
static SimConstValUtils const kcg_int32_constants[] = {
    { "cFLOOR_TRAVEL_TIME", &TU_cFLOOR_TRAVEL_TIME },
    { "cDOOR_MOVE_TIME", &TU_cDOOR_MOVE_TIME },
};
...
/****************************************************************
 ** SSM_ST_elevator_state 
 ****************************************************************/

#ifdef __cplusplus
  #ifdef pSimSSM_ST_elevator_stateVTable_defined
    extern struct SimTypeVTable *pSimSSM_ST_elevator_stateVTable;
  #else 
    struct SimTypeVTable *pSimSSM_ST_elevator_stateVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_ST_elevator_stateVTable;
#endif

static SimEnumValUtils SSM_ST_elevator_state_values[] = {
    { "STOPPED", SSM_st_STOPPED_elevator_state},
    { "STOPPED", SSM_st_STOPPED_elevator_state},
    { "RUNNING", SSM_st_RUNNING_elevator_state},
    { "RUNNING", SSM_st_RUNNING_elevator_state},
};
const int SSM_ST_elevator_state_nb_values = 4;

int SSM_ST_elevator_state_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_ST_elevator_stateVTable != NULL
        && pSimSSM_ST_elevator_stateVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_ST_elevator_stateVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_ST_elevator_state*)pValue, SSM_ST_elevator_state_values, SSM_ST_elevator_state_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_ST_elevator_state_string(const char *str, char **endptr)
{
    static SSM_ST_elevator_state rTemp;
    return string_to_SSM_ST_elevator_state(str, (void*)&rTemp, endptr);
}

int string_to_SSM_ST_elevator_state(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_ST_elevator_stateVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_ST_elevator_stateVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_ST_elevator_state_values, SSM_ST_elevator_state_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_ST_elevator_state*)pValue = (SSM_ST_elevator_state)nTemp;
    }
    return nRet;
}

int is_SSM_ST_elevator_state_double_conversion_allowed()
{
    if (pSimSSM_ST_elevator_stateVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_ST_elevator_stateVTable);
    }
    return 1;
}

int SSM_ST_elevator_state_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_ST_elevator_stateVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_ST_elevator_stateVTable, nValue);
    }
    *nValue = (double)*((SSM_ST_elevator_state*)pValue);
    return 1;
}

int is_SSM_ST_elevator_state_long_conversion_allowed()
{
    if (pSimSSM_ST_elevator_stateVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_ST_elevator_stateVTable);
    }
    return 1;
}

int SSM_ST_elevator_state_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_ST_elevator_stateVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_ST_elevator_stateVTable, nValue);
    }
    *nValue = (long)*((SSM_ST_elevator_state*)pValue);
    return 1;
}

void compare_SSM_ST_elevator_state(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_ST_elevator_stateVTable != NULL
        && pSimSSM_ST_elevator_stateVTable->m_version >= Scv612
        && pSimSSM_ST_elevator_stateVTable->m_pfnCompare != NULL) {
        if (pSimSSM_ST_elevator_stateVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_ST_elevator_stateVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_ST_elevator_stateVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_ST_elevator_state*)pValue1), (int)(*(SSM_ST_elevator_state*)pValue2));
    }
    UNUSED(pTol);
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
...
int get_SSM_ST_elevator_state_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_ST_elevator_state_values, SSM_ST_elevator_state_nb_values, pfnStrAppend, pStrObj);
}

int init_SSM_ST_elevator_state(void *pValue)
{
    *(SSM_ST_elevator_state*)pValue = SSM_st_STOPPED_elevator_state;
    return 1;
}

int release_SSM_ST_elevator_state(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_SSM_ST_elevator_state(void *pToValue, const void *pFromValue)
{
    *((SSM_ST_elevator_state*)pToValue) = *((SSM_ST_elevator_state*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_ST_elevator_state_Utils = {
    SSM_ST_elevator_state_to_string,
    check_SSM_ST_elevator_state_string,
    string_to_SSM_ST_elevator_state,
    is_SSM_ST_elevator_state_double_conversion_allowed,
    SSM_ST_elevator_state_to_double,
    is_SSM_ST_elevator_state_long_conversion_allowed,
    SSM_ST_elevator_state_to_long,
    compare_SSM_ST_elevator_state,
    get_SSM_ST_elevator_state_signature,
    init_SSM_ST_elevator_state,
    release_SSM_ST_elevator_state,
    copy_SSM_ST_elevator_state,
    sizeof(SSM_ST_elevator_state)
};
...
{
    *(SSM_ST_SM1*)pValue = SSM_st_CLOSED_SM1;
    return 1;
}
...
#ifdef __cplusplus
  #ifdef pSimSSM_ST_SM2_RUNNING_elevator_stateVTable_defined
    extern struct SimTypeVTable *pSimSSM_ST_SM2_RUNNING_elevator_stateVTable;
  #else 
    struct SimTypeVTable *pSimSSM_ST_SM2_RUNNING_elevator_stateVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_ST_SM2_RUNNING_elevator_stateVTable;
#endif

static SimEnumValUtils SSM_ST_SM2_RUNNING_elevator_state_values[] = {
    { "SET_MOVEMENT", SSM_st_SET_MOVEMENT_SM2_RUNNING_elevator_state},
    { "SET_MOVEMENT", SSM_st_SET_MOVEMENT_SM2_RUNNING_elevator_state},
    { "ELEVATOR_CLIMB", SSM_st_ELEVATOR_CLIMB_SM2_RUNNING_elevator_state},
    { "ELEVATOR_CLIMB", SSM_st_ELEVATOR_CLIMB_SM2_RUNNING_elevator_state},
    { "ELEVATOR_DOWN", SSM_st_ELEVATOR_DOWN_SM2_RUNNING_elevator_state},
    { "ELEVATOR_DOWN", SSM_st_ELEVATOR_DOWN_SM2_RUNNING_elevator_state},
    { "CLOSE_DOORS", SSM_st_CLOSE_DOORS_SM2_RUNNING_elevator_state},
    { "CLOSE_DOORS", SSM_st_CLOSE_DOORS_SM2_RUNNING_elevator_state},
};
const int SSM_ST_SM2_RUNNING_elevator_state_nb_values = 8;

int SSM_ST_SM2_RUNNING_elevator_state_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_ST_SM2_RUNNING_elevator_stateVTable != NULL
        && pSimSSM_ST_SM2_RUNNING_elevator_stateVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_ST_SM2_RUNNING_elevator_stateVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_ST_SM2_RUNNING_elevator_state*)pValue, SSM_ST_SM2_RUNNING_elevator_state_values, SSM_ST_SM2_RUNNING_elevator_state_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_ST_SM2_RUNNING_elevator_state_string(const char *str, char **endptr)
{
    static SSM_ST_SM2_RUNNING_elevator_state rTemp;
    return string_to_SSM_ST_SM2_RUNNING_elevator_state(str, (void*)&rTemp, endptr);
}

int string_to_SSM_ST_SM2_RUNNING_elevator_state(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_ST_SM2_RUNNING_elevator_stateVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_ST_SM2_RUNNING_elevator_stateVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_ST_SM2_RUNNING_elevator_state_values, SSM_ST_SM2_RUNNING_elevator_state_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_ST_SM2_RUNNING_elevator_state*)pValue = (SSM_ST_SM2_RUNNING_elevator_state)nTemp;
    }
    return nRet;
}

int is_SSM_ST_SM2_RUNNING_elevator_state_double_conversion_allowed()
{
    if (pSimSSM_ST_SM2_RUNNING_elevator_stateVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_ST_SM2_RUNNING_elevator_stateVTable);
    }
    return 1;
}

int SSM_ST_SM2_RUNNING_elevator_state_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_ST_SM2_RUNNING_elevator_stateVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_ST_SM2_RUNNING_elevator_stateVTable, nValue);
    }
    *nValue = (double)*((SSM_ST_SM2_RUNNING_elevator_state*)pValue);
    return 1;
}

int is_SSM_ST_SM2_RUNNING_elevator_state_long_conversion_allowed()
{
    if (pSimSSM_ST_SM2_RUNNING_elevator_stateVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_ST_SM2_RUNNING_elevator_stateVTable);
    }
    return 1;
}

int SSM_ST_SM2_RUNNING_elevator_state_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_ST_SM2_RUNNING_elevator_stateVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_ST_SM2_RUNNING_elevator_stateVTable, nValue);
    }
    *nValue = (long)*((SSM_ST_SM2_RUNNING_elevator_state*)pValue);
    return 1;
}

void compare_SSM_ST_SM2_RUNNING_elevator_state(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_ST_SM2_RUNNING_elevator_stateVTable != NULL
        && pSimSSM_ST_SM2_RUNNING_elevator_stateVTable->m_version >= Scv612
        && pSimSSM_ST_SM2_RUNNING_elevator_stateVTable->m_pfnCompare != NULL) {
        if (pSimSSM_ST_SM2_RUNNING_elevator_stateVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_ST_SM2_RUNNING_elevator_stateVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_ST_SM2_RUNNING_elevator_stateVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_ST_SM2_RUNNING_elevator_state*)pValue1), (int)(*(SSM_ST_SM2_RUNNING_elevator_state*)pValue2));
    }
    UNUSED(pTol);
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
...
int get_SSM_ST_SM2_RUNNING_elevator_state_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_ST_SM2_RUNNING_elevator_state_values, SSM_ST_SM2_RUNNING_elevator_state_nb_values, pfnStrAppend, pStrObj);
}

int init_SSM_ST_SM2_RUNNING_elevator_state(void *pValue)
{
    *(SSM_ST_SM2_RUNNING_elevator_state*)pValue = SSM_st_SET_MOVEMENT_SM2_RUNNING_elevator_state;
    return 1;
}

int release_SSM_ST_SM2_RUNNING_elevator_state(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_SSM_ST_SM2_RUNNING_elevator_state(void *pToValue, const void *pFromValue)
{
    *((SSM_ST_SM2_RUNNING_elevator_state*)pToValue) = *((SSM_ST_SM2_RUNNING_elevator_state*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_ST_SM2_RUNNING_elevator_state_Utils = {
    SSM_ST_SM2_RUNNING_elevator_state_to_string,
    check_SSM_ST_SM2_RUNNING_elevator_state_string,
    string_to_SSM_ST_SM2_RUNNING_elevator_state,
    is_SSM_ST_SM2_RUNNING_elevator_state_double_conversion_allowed,
    SSM_ST_SM2_RUNNING_elevator_state_to_double,
    is_SSM_ST_SM2_RUNNING_elevator_state_long_conversion_allowed,
    SSM_ST_SM2_RUNNING_elevator_state_to_long,
    compare_SSM_ST_SM2_RUNNING_elevator_state,
    get_SSM_ST_SM2_RUNNING_elevator_state_signature,
    init_SSM_ST_SM2_RUNNING_elevator_state,
    release_SSM_ST_SM2_RUNNING_elevator_state,
    copy_SSM_ST_SM2_RUNNING_elevator_state,
    sizeof(SSM_ST_SM2_RUNNING_elevator_state)
};

/****************************************************************
 ** SSM_TR_elevator_state 
 ****************************************************************/

#ifdef __cplusplus
  #ifdef pSimSSM_TR_elevator_stateVTable_defined
    extern struct SimTypeVTable *pSimSSM_TR_elevator_stateVTable;
  #else 
    struct SimTypeVTable *pSimSSM_TR_elevator_stateVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_TR_elevator_stateVTable;
#endif

static SimEnumValUtils SSM_TR_elevator_state_values[] = {
    { "SSM_TR_no_trans_elevator_state", SSM_TR_no_trans_elevator_state},
    { "SSM_TR_no_trans_elevator_state", SSM_TR_no_trans_elevator_state},
    { "SSM_TR_STOPPED_RUNNING_1_STOPPED_elevator_state", SSM_TR_STOPPED_RUNNING_1_STOPPED_elevator_state},
    { "SSM_TR_STOPPED_RUNNING_1_STOPPED_elevator_state", SSM_TR_STOPPED_RUNNING_1_STOPPED_elevator_state},
    { "SSM_TR_RUNNING_STOPPED_1_RUNNING_elevator_state", SSM_TR_RUNNING_STOPPED_1_RUNNING_elevator_state},
    { "SSM_TR_RUNNING_STOPPED_1_RUNNING_elevator_state", SSM_TR_RUNNING_STOPPED_1_RUNNING_elevator_state},
};
const int SSM_TR_elevator_state_nb_values = 6;

int SSM_TR_elevator_state_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_TR_elevator_stateVTable != NULL
        && pSimSSM_TR_elevator_stateVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_TR_elevator_stateVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_TR_elevator_state*)pValue, SSM_TR_elevator_state_values, SSM_TR_elevator_state_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_TR_elevator_state_string(const char *str, char **endptr)
{
    static SSM_TR_elevator_state rTemp;
    return string_to_SSM_TR_elevator_state(str, (void*)&rTemp, endptr);
}

int string_to_SSM_TR_elevator_state(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_TR_elevator_stateVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_TR_elevator_stateVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_TR_elevator_state_values, SSM_TR_elevator_state_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_TR_elevator_state*)pValue = (SSM_TR_elevator_state)nTemp;
    }
    return nRet;
}

int is_SSM_TR_elevator_state_double_conversion_allowed()
{
    if (pSimSSM_TR_elevator_stateVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_TR_elevator_stateVTable);
    }
    return 1;
}

int SSM_TR_elevator_state_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_TR_elevator_stateVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_TR_elevator_stateVTable, nValue);
    }
    *nValue = (double)*((SSM_TR_elevator_state*)pValue);
    return 1;
}

int is_SSM_TR_elevator_state_long_conversion_allowed()
{
    if (pSimSSM_TR_elevator_stateVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_TR_elevator_stateVTable);
    }
    return 1;
}

int SSM_TR_elevator_state_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_TR_elevator_stateVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_TR_elevator_stateVTable, nValue);
    }
    *nValue = (long)*((SSM_TR_elevator_state*)pValue);
    return 1;
}

void compare_SSM_TR_elevator_state(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_TR_elevator_stateVTable != NULL
        && pSimSSM_TR_elevator_stateVTable->m_version >= Scv612
        && pSimSSM_TR_elevator_stateVTable->m_pfnCompare != NULL) {
        if (pSimSSM_TR_elevator_stateVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_TR_elevator_stateVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_TR_elevator_stateVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_TR_elevator_state*)pValue1), (int)(*(SSM_TR_elevator_state*)pValue2));
    }
    UNUSED(pTol);
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
...
int get_SSM_TR_elevator_state_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_TR_elevator_state_values, SSM_TR_elevator_state_nb_values, pfnStrAppend, pStrObj);
}

int init_SSM_TR_elevator_state(void *pValue)
{
    *(SSM_TR_elevator_state*)pValue = SSM_TR_no_trans_elevator_state;
    return 1;
}

int release_SSM_TR_elevator_state(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_SSM_TR_elevator_state(void *pToValue, const void *pFromValue)
{
    *((SSM_TR_elevator_state*)pToValue) = *((SSM_TR_elevator_state*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_TR_elevator_state_Utils = {
    SSM_TR_elevator_state_to_string,
    check_SSM_TR_elevator_state_string,
    string_to_SSM_TR_elevator_state,
    is_SSM_TR_elevator_state_double_conversion_allowed,
    SSM_TR_elevator_state_to_double,
    is_SSM_TR_elevator_state_long_conversion_allowed,
    SSM_TR_elevator_state_to_long,
    compare_SSM_TR_elevator_state,
    get_SSM_TR_elevator_state_signature,
    init_SSM_TR_elevator_state,
    release_SSM_TR_elevator_state,
    copy_SSM_TR_elevator_state,
    sizeof(SSM_TR_elevator_state)
};
...
static SimEnumValUtils SSM_TR_SM1_values[] = {
    ...
    { "SSM_TR_no_trans_SM1", SSM_TR_no_trans_SM1},
    { "SSM_TR_CLOSED_OPENING_1_CLOSED_SM1", SSM_TR_CLOSED_OPENING_1_CLOSED_SM1},
    { "SSM_TR_CLOSED_OPENING_1_CLOSED_SM1", SSM_TR_CLOSED_OPENING_1_CLOSED_SM1},
    { "SSM_TR_CLOSING_CLOSED_1_CLOSING_SM1", SSM_TR_CLOSING_CLOSED_1_CLOSING_SM1},
    { "SSM_TR_CLOSING_CLOSED_1_CLOSING_SM1", SSM_TR_CLOSING_CLOSED_1_CLOSING_SM1},
    { "SSM_TR_CLOSING_OPENING_2_CLOSING_SM1", SSM_TR_CLOSING_OPENING_2_CLOSING_SM1},
    { "SSM_TR_CLOSING_OPENING_2_CLOSING_SM1", SSM_TR_CLOSING_OPENING_2_CLOSING_SM1},
    { "SSM_TR_OPENING_OPENED_1_OPENING_SM1", SSM_TR_OPENING_OPENED_1_OPENING_SM1},
    { "SSM_TR_OPENING_OPENED_1_OPENING_SM1", SSM_TR_OPENING_OPENED_1_OPENING_SM1},
    { "SSM_TR_OPENING_CLOSING_2_OPENING_SM1", SSM_TR_OPENING_CLOSING_2_OPENING_SM1},
    { "SSM_TR_OPENING_CLOSING_2_OPENING_SM1", SSM_TR_OPENING_CLOSING_2_OPENING_SM1},
    { "SSM_TR_OPENED_CLOSING_1_OPENED_SM1", SSM_TR_OPENED_CLOSING_1_OPENED_SM1},
    { "SSM_TR_OPENED_CLOSING_1_OPENED_SM1", SSM_TR_OPENED_CLOSING_1_OPENED_SM1},
};
const int SSM_TR_SM1_nb_values = 14;
...
#ifdef __cplusplus
  #ifdef pSimSSM_TR_SM2_RUNNING_elevator_stateVTable_defined
    extern struct SimTypeVTable *pSimSSM_TR_SM2_RUNNING_elevator_stateVTable;
  #else 
    struct SimTypeVTable *pSimSSM_TR_SM2_RUNNING_elevator_stateVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimSSM_TR_SM2_RUNNING_elevator_stateVTable;
#endif

static SimEnumValUtils SSM_TR_SM2_RUNNING_elevator_state_values[] = {
    { "SSM_TR_no_trans_SM2_RUNNING_elevator_state", SSM_TR_no_trans_SM2_RUNNING_elevator_state},
    { "SSM_TR_no_trans_SM2_RUNNING_elevator_state", SSM_TR_no_trans_SM2_RUNNING_elevator_state},
    { "SSM_TR_SET_MOVEMENT_ELEVATOR_DOWN_1_SET_MOVEMENT_SM2_RUNNING_elevator_state", SSM_TR_SET_MOVEMENT_ELEVATOR_DOWN_1_SET_MOVEMENT_SM2_RUNNING_elevator_state},
    { "SSM_TR_SET_MOVEMENT_ELEVATOR_DOWN_1_SET_MOVEMENT_SM2_RUNNING_elevator_state", SSM_TR_SET_MOVEMENT_ELEVATOR_DOWN_1_SET_MOVEMENT_SM2_RUNNING_elevator_state},
    { "SSM_TR_SET_MOVEMENT_ELEVATOR_CLIMB_2_SET_MOVEMENT_SM2_RUNNING_elevator_state", SSM_TR_SET_MOVEMENT_ELEVATOR_CLIMB_2_SET_MOVEMENT_SM2_RUNNING_elevator_state},
    { "SSM_TR_SET_MOVEMENT_ELEVATOR_CLIMB_2_SET_MOVEMENT_SM2_RUNNING_elevator_state", SSM_TR_SET_MOVEMENT_ELEVATOR_CLIMB_2_SET_MOVEMENT_SM2_RUNNING_elevator_state},
    { "SSM_TR_ELEVATOR_CLIMB_SET_MOVEMENT_1_ELEVATOR_CLIMB_SM2_RUNNING_elevator_state", SSM_TR_ELEVATOR_CLIMB_SET_MOVEMENT_1_ELEVATOR_CLIMB_SM2_RUNNING_elevator_state},
    { "SSM_TR_ELEVATOR_CLIMB_SET_MOVEMENT_1_ELEVATOR_CLIMB_SM2_RUNNING_elevator_state", SSM_TR_ELEVATOR_CLIMB_SET_MOVEMENT_1_ELEVATOR_CLIMB_SM2_RUNNING_elevator_state},
    { "SSM_TR_ELEVATOR_DOWN_SET_MOVEMENT_1_ELEVATOR_DOWN_SM2_RUNNING_elevator_state", SSM_TR_ELEVATOR_DOWN_SET_MOVEMENT_1_ELEVATOR_DOWN_SM2_RUNNING_elevator_state},
    { "SSM_TR_ELEVATOR_DOWN_SET_MOVEMENT_1_ELEVATOR_DOWN_SM2_RUNNING_elevator_state", SSM_TR_ELEVATOR_DOWN_SET_MOVEMENT_1_ELEVATOR_DOWN_SM2_RUNNING_elevator_state},
    { "SSM_TR_CLOSE_DOORS_SET_MOVEMENT_1_CLOSE_DOORS_SM2_RUNNING_elevator_state", SSM_TR_CLOSE_DOORS_SET_MOVEMENT_1_CLOSE_DOORS_SM2_RUNNING_elevator_state},
    { "SSM_TR_CLOSE_DOORS_SET_MOVEMENT_1_CLOSE_DOORS_SM2_RUNNING_elevator_state", SSM_TR_CLOSE_DOORS_SET_MOVEMENT_1_CLOSE_DOORS_SM2_RUNNING_elevator_state},
};
const int SSM_TR_SM2_RUNNING_elevator_state_nb_values = 12;

int SSM_TR_SM2_RUNNING_elevator_state_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimSSM_TR_SM2_RUNNING_elevator_stateVTable != NULL
        && pSimSSM_TR_SM2_RUNNING_elevator_stateVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimSSM_TR_SM2_RUNNING_elevator_stateVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(SSM_TR_SM2_RUNNING_elevator_state*)pValue, SSM_TR_SM2_RUNNING_elevator_state_values, SSM_TR_SM2_RUNNING_elevator_state_nb_values, pfnStrAppend, pStrObj); 
}

int check_SSM_TR_SM2_RUNNING_elevator_state_string(const char *str, char **endptr)
{
    static SSM_TR_SM2_RUNNING_elevator_state rTemp;
    return string_to_SSM_TR_SM2_RUNNING_elevator_state(str, (void*)&rTemp, endptr);
}

int string_to_SSM_TR_SM2_RUNNING_elevator_state(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimSSM_TR_SM2_RUNNING_elevator_stateVTable != NULL) {
        nRet = string_to_VTable(str, pSimSSM_TR_SM2_RUNNING_elevator_stateVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, SSM_TR_SM2_RUNNING_elevator_state_values, SSM_TR_SM2_RUNNING_elevator_state_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(SSM_TR_SM2_RUNNING_elevator_state*)pValue = (SSM_TR_SM2_RUNNING_elevator_state)nTemp;
    }
    return nRet;
}

int is_SSM_TR_SM2_RUNNING_elevator_state_double_conversion_allowed()
{
    if (pSimSSM_TR_SM2_RUNNING_elevator_stateVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimSSM_TR_SM2_RUNNING_elevator_stateVTable);
    }
    return 1;
}

int SSM_TR_SM2_RUNNING_elevator_state_to_double(const void *pValue, double *nValue)
{
    if (pSimSSM_TR_SM2_RUNNING_elevator_stateVTable != NULL) {
        return VTable_to_double(pValue, pSimSSM_TR_SM2_RUNNING_elevator_stateVTable, nValue);
    }
    *nValue = (double)*((SSM_TR_SM2_RUNNING_elevator_state*)pValue);
    return 1;
}

int is_SSM_TR_SM2_RUNNING_elevator_state_long_conversion_allowed()
{
    if (pSimSSM_TR_SM2_RUNNING_elevator_stateVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimSSM_TR_SM2_RUNNING_elevator_stateVTable);
    }
    return 1;
}

int SSM_TR_SM2_RUNNING_elevator_state_to_long(const void *pValue, long *nValue)
{
    if (pSimSSM_TR_SM2_RUNNING_elevator_stateVTable != NULL) {
        return VTable_to_long(pValue, pSimSSM_TR_SM2_RUNNING_elevator_stateVTable, nValue);
    }
    *nValue = (long)*((SSM_TR_SM2_RUNNING_elevator_state*)pValue);
    return 1;
}

void compare_SSM_TR_SM2_RUNNING_elevator_state(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimSSM_TR_SM2_RUNNING_elevator_stateVTable != NULL
        && pSimSSM_TR_SM2_RUNNING_elevator_stateVTable->m_version >= Scv612
        && pSimSSM_TR_SM2_RUNNING_elevator_stateVTable->m_pfnCompare != NULL) {
        if (pSimSSM_TR_SM2_RUNNING_elevator_stateVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimSSM_TR_SM2_RUNNING_elevator_stateVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimSSM_TR_SM2_RUNNING_elevator_stateVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(SSM_TR_SM2_RUNNING_elevator_state*)pValue1), (int)(*(SSM_TR_SM2_RUNNING_elevator_state*)pValue2));
    }
    UNUSED(pTol);
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
...
int get_SSM_TR_SM2_RUNNING_elevator_state_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(SSM_TR_SM2_RUNNING_elevator_state_values, SSM_TR_SM2_RUNNING_elevator_state_nb_values, pfnStrAppend, pStrObj);
}

int init_SSM_TR_SM2_RUNNING_elevator_state(void *pValue)
{
    *(SSM_TR_SM2_RUNNING_elevator_state*)pValue = SSM_TR_no_trans_SM2_RUNNING_elevator_state;
    return 1;
}

int release_SSM_TR_SM2_RUNNING_elevator_state(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_SSM_TR_SM2_RUNNING_elevator_state(void *pToValue, const void *pFromValue)
{
    *((SSM_TR_SM2_RUNNING_elevator_state*)pToValue) = *((SSM_TR_SM2_RUNNING_elevator_state*)pFromValue);
    return 1;
}

SimTypeUtils _Type_SSM_TR_SM2_RUNNING_elevator_state_Utils = {
    SSM_TR_SM2_RUNNING_elevator_state_to_string,
    check_SSM_TR_SM2_RUNNING_elevator_state_string,
    string_to_SSM_TR_SM2_RUNNING_elevator_state,
    is_SSM_TR_SM2_RUNNING_elevator_state_double_conversion_allowed,
    SSM_TR_SM2_RUNNING_elevator_state_to_double,
    is_SSM_TR_SM2_RUNNING_elevator_state_long_conversion_allowed,
    SSM_TR_SM2_RUNNING_elevator_state_to_long,
    compare_SSM_TR_SM2_RUNNING_elevator_state,
    get_SSM_TR_SM2_RUNNING_elevator_state_signature,
    init_SSM_TR_SM2_RUNNING_elevator_state,
    release_SSM_TR_SM2_RUNNING_elevator_state,
    copy_SSM_TR_SM2_RUNNING_elevator_state,
    sizeof(SSM_TR_SM2_RUNNING_elevator_state)
};
...
#ifdef __cplusplus
  #ifdef pSimtDoorStatusEnumVTable_defined
    extern struct SimTypeVTable *pSimtDoorStatusEnumVTable;
  #else 
    struct SimTypeVTable *pSimtDoorStatusEnumVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimtDoorStatusEnumVTable;
#endif

static SimEnumValUtils tDoorStatusEnum_values[] = {
    { "eDOOR_CLOSED", eDOOR_CLOSED},
    { "eDOOR_CLOSED", eDOOR_CLOSED},
    { "eDOOR_OPENED", eDOOR_OPENED},
    { "eDOOR_OPENED", eDOOR_OPENED},
    { "eDOOR_CLOSING", eDOOR_CLOSING},
    { "eDOOR_CLOSING", eDOOR_CLOSING},
    { "eDOOR_OPENING", eDOOR_OPENING},
    { "eDOOR_OPENING", eDOOR_OPENING},
};
const int tDoorStatusEnum_nb_values = 8;

int tDoorStatusEnum_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimtDoorStatusEnumVTable != NULL
        && pSimtDoorStatusEnumVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimtDoorStatusEnumVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(tDoorStatusEnum*)pValue, tDoorStatusEnum_values, tDoorStatusEnum_nb_values, pfnStrAppend, pStrObj); 
}

int check_tDoorStatusEnum_string(const char *str, char **endptr)
{
    static tDoorStatusEnum rTemp;
    return string_to_tDoorStatusEnum(str, (void*)&rTemp, endptr);
}

int string_to_tDoorStatusEnum(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimtDoorStatusEnumVTable != NULL) {
        nRet = string_to_VTable(str, pSimtDoorStatusEnumVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, tDoorStatusEnum_values, tDoorStatusEnum_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(tDoorStatusEnum*)pValue = (tDoorStatusEnum)nTemp;
    }
    return nRet;
}

int is_tDoorStatusEnum_double_conversion_allowed()
{
    if (pSimtDoorStatusEnumVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimtDoorStatusEnumVTable);
    }
    return 1;
}

int tDoorStatusEnum_to_double(const void *pValue, double *nValue)
{
    if (pSimtDoorStatusEnumVTable != NULL) {
        return VTable_to_double(pValue, pSimtDoorStatusEnumVTable, nValue);
    }
    *nValue = (double)*((tDoorStatusEnum*)pValue);
    return 1;
}

int is_tDoorStatusEnum_long_conversion_allowed()
{
    if (pSimtDoorStatusEnumVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimtDoorStatusEnumVTable);
    }
    return 1;
}

int tDoorStatusEnum_to_long(const void *pValue, long *nValue)
{
    if (pSimtDoorStatusEnumVTable != NULL) {
        return VTable_to_long(pValue, pSimtDoorStatusEnumVTable, nValue);
    }
    *nValue = (long)*((tDoorStatusEnum*)pValue);
    return 1;
}

void compare_tDoorStatusEnum(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimtDoorStatusEnumVTable != NULL
        && pSimtDoorStatusEnumVTable->m_version >= Scv612
        && pSimtDoorStatusEnumVTable->m_pfnCompare != NULL) {
        if (pSimtDoorStatusEnumVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimtDoorStatusEnumVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimtDoorStatusEnumVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(tDoorStatusEnum*)pValue1), (int)(*(tDoorStatusEnum*)pValue2));
    }
    UNUSED(pTol);
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
...
int get_tDoorStatusEnum_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(tDoorStatusEnum_values, tDoorStatusEnum_nb_values, pfnStrAppend, pStrObj);
}

int init_tDoorStatusEnum(void *pValue)
{
    *(tDoorStatusEnum*)pValue = eDOOR_CLOSED;
    return 1;
}

int release_tDoorStatusEnum(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_tDoorStatusEnum(void *pToValue, const void *pFromValue)
{
    *((tDoorStatusEnum*)pToValue) = *((tDoorStatusEnum*)pFromValue);
    return 1;
}

SimTypeUtils _Type_tDoorStatusEnum_Utils = {
    tDoorStatusEnum_to_string,
    check_tDoorStatusEnum_string,
    string_to_tDoorStatusEnum,
    is_tDoorStatusEnum_double_conversion_allowed,
    tDoorStatusEnum_to_double,
    is_tDoorStatusEnum_long_conversion_allowed,
    tDoorStatusEnum_to_long,
    compare_tDoorStatusEnum,
    get_tDoorStatusEnum_signature,
    init_tDoorStatusEnum,
    release_tDoorStatusEnum,
    copy_tDoorStatusEnum,
    sizeof(tDoorStatusEnum)
};
...
#ifdef __cplusplus
  #ifdef pSimtMotorCommandVTable_defined
    extern struct SimTypeVTable *pSimtMotorCommandVTable;
  #else 
    struct SimTypeVTable *pSimtMotorCommandVTable = NULL;
  #endif
#else
  struct SimTypeVTable *pSimtMotorCommandVTable;
#endif

static SimEnumValUtils tMotorCommand_values[] = {
    { "eMOTOR_STOP", eMOTOR_STOP},
    { "eMOTOR_STOP", eMOTOR_STOP},
    { "eMOTOR_MOVEUP", eMOTOR_MOVEUP},
    { "eMOTOR_MOVEUP", eMOTOR_MOVEUP},
    { "eMOTOR_MOVEDOWN", eMOTOR_MOVEDOWN},
    { "eMOTOR_MOVEDOWN", eMOTOR_MOVEDOWN},
};
const int tMotorCommand_nb_values = 6;

int tMotorCommand_to_string(const void *pValue, PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    if (pSimtMotorCommandVTable != NULL
        && pSimtMotorCommandVTable->m_pfnGetConvInfo(SptString, SptNone) == 1) {
       return pfnStrAppend(*(char**)pSimtMotorCommandVTable->m_pfnToType(SptString, pValue), pStrObj);
    }
    return pConverter->m_pfnEnumToString(*(tMotorCommand*)pValue, tMotorCommand_values, tMotorCommand_nb_values, pfnStrAppend, pStrObj); 
}

int check_tMotorCommand_string(const char *str, char **endptr)
{
    static tMotorCommand rTemp;
    return string_to_tMotorCommand(str, (void*)&rTemp, endptr);
}

int string_to_tMotorCommand(const char *str, void *pValue, char **endptr)
{
    int nRet = 0;
    skip_whitespace(str);
    if (pSimtMotorCommandVTable != NULL) {
        nRet = string_to_VTable(str, pSimtMotorCommandVTable, pValue, endptr);
    }
    if (nRet == 0) {
        int nTemp = 0;
        nRet = pConverter->m_pfnStringToEnum(str, &nTemp, tMotorCommand_values, tMotorCommand_nb_values, endptr);
        if (pValue != NULL && nRet != 0)
            *(tMotorCommand*)pValue = (tMotorCommand)nTemp;
    }
    return nRet;
}

int is_tMotorCommand_double_conversion_allowed()
{
    if (pSimtMotorCommandVTable != NULL) {
        return is_VTable_double_conversion_allowed(pSimtMotorCommandVTable);
    }
    return 1;
}

int tMotorCommand_to_double(const void *pValue, double *nValue)
{
    if (pSimtMotorCommandVTable != NULL) {
        return VTable_to_double(pValue, pSimtMotorCommandVTable, nValue);
    }
    *nValue = (double)*((tMotorCommand*)pValue);
    return 1;
}

int is_tMotorCommand_long_conversion_allowed()
{
    if (pSimtMotorCommandVTable != NULL) {
        return is_VTable_long_conversion_allowed(pSimtMotorCommandVTable);
    }
    return 1;
}

int tMotorCommand_to_long(const void *pValue, long *nValue)
{
    if (pSimtMotorCommandVTable != NULL) {
        return VTable_to_long(pValue, pSimtMotorCommandVTable, nValue);
    }
    *nValue = (long)*((tMotorCommand*)pValue);
    return 1;
}

void compare_tMotorCommand(int *pResult, const void *pValue1, const void *pValue2, SimTolerance *pTol, const char *pszPath, PFN_STR_LIST_APPEND pfnStrListAppend, void *pListErrPaths)
{
    int unitResult = 0;
    /* Customized comparison */
    if (pSimtMotorCommandVTable != NULL
        && pSimtMotorCommandVTable->m_version >= Scv612
        && pSimtMotorCommandVTable->m_pfnCompare != NULL) {
        if (pSimtMotorCommandVTable->m_version >= Scv65) {
            /* R15 and higher: VTable Compare function shall UPDATE *pResult global flag (*pResult |= SIM_CMP_RES_LT/...): */
            unitResult = pSimtMotorCommandVTable->m_pfnCompare(pResult, pValue1, pValue2);
        } else {
            /* Before R15: VTable Compare function shall SET *pResult global flag (*pResult = -1/1/0): */
            pSimtMotorCommandVTable->m_pfnCompare(&unitResult, pValue1, pValue2);
            updateCompareResult(unitResult, pResult);
        }
    } else {
        /* Predefined comparison */
        unitResult = predef_compare_enum(pResult, (int)(*(tMotorCommand*)pValue1), (int)(*(tMotorCommand*)pValue2));
    }
    UNUSED(pTol);
    if (unitResult != 0 && pfnStrListAppend != NULL && pszPath != NULL && *pszPath != 0 && pListErrPaths != NULL)
        pfnStrListAppend(pszPath, pListErrPaths);
...
int get_tMotorCommand_signature(PFN_STR_APPEND pfnStrAppend, void *pStrObj)
{
    return pConverter->m_pfnGetEnumSignature(tMotorCommand_values, tMotorCommand_nb_values, pfnStrAppend, pStrObj);
}

int init_tMotorCommand(void *pValue)
{
    *(tMotorCommand*)pValue = eMOTOR_STOP;
    return 1;
}

int release_tMotorCommand(void *pValue)
{
    UNUSED(pValue);
    return 1;
}

int copy_tMotorCommand(void *pToValue, const void *pFromValue)
{
    *((tMotorCommand*)pToValue) = *((tMotorCommand*)pFromValue);
    return 1;
}

SimTypeUtils _Type_tMotorCommand_Utils = {
    tMotorCommand_to_string,
    check_tMotorCommand_string,
    string_to_tMotorCommand,
    is_tMotorCommand_double_conversion_allowed,
    tMotorCommand_to_double,
    is_tMotorCommand_long_conversion_allowed,
    tMotorCommand_to_long,
    compare_tMotorCommand,
    get_tMotorCommand_signature,
    init_tMotorCommand,
    release_tMotorCommand,
    copy_tMotorCommand,
    sizeof(tMotorCommand)
};
