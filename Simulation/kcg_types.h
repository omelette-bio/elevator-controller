...
/* Elevator::ElevatorModes/elevator_state: */
typedef enum kcg_tag_SSM_TR_elevator_state {
  SSM_TR_no_trans_elevator_state,
  SSM_TR_STOPPED_RUNNING_1_STOPPED_elevator_state,
  SSM_TR_RUNNING_STOPPED_1_RUNNING_elevator_state
} SSM_TR_elevator_state;
/* Elevator::ElevatorModes/elevator_state: */
typedef enum kcg_tag_SSM_ST_elevator_state {
  SSM_st_STOPPED_elevator_state,
  SSM_st_RUNNING_elevator_state
} SSM_ST_elevator_state;
/* Elevator::ElevatorModes/elevator_state:RUNNING:SM2: */
